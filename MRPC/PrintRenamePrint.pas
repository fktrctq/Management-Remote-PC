...
type
  PrintRenamePrinter = class(TThread)
  private
...
procedure PrintRenamePrinter.Execute;
var
...
begin
  ...
  frmDomainInfo.memo1.Lines.Add('Переименовать принтер.');
  ...
  oEnum:= IUnknown(FWbemObjectSet._NewEnum) as IEnumVariant;
    if oEnum.Next(1, FWbemObject, iValue) = 0 then
      begin
         ...
         MyError:=FWbemObject.RenamePrinter(NewNamePrint);
         frmDomainInfo.memo1.Lines.Add('Переименовать принтер '+SysErrorMessage(MyError));
         frmDomainInfo.memo1.Lines.Add('---------------------------');
      end;
  oEnum:=nil;
...
on E:Exception do
         begin
           frmDomainInfo.memo1.Lines.Add('Ошибка переименования принтера "'+E.Message+'"');
           frmDomainInfo.memo1.Lines.Add('---------------------------');
           OleUnInitialize;
           exit;
         end;
